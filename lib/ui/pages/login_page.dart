...
class _LoginPageState extends State<LoginPage> {
  ...
  void initState() {
    widget.presenter.isBusyStream
        .listen((isBusy) => setState(() => this.isBusy = isBusy));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<LoginViewModel>(
      stream: widget.presenter.loginStream,
      builder: (context, snapshot) {
        ...
        if (viewModel?.user.id.isNotEmpty ?? false) {
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: FilledButton(
                      ...
                      onPressed: isBusy
                          ? null
                          : () => widget.presenter.authenticateWithGoogle(),
                      child: Text(
                        'Login com Google',
                        style: Theme.of(context).textTheme.bodyLarge!.copyWith(
                              color: Colors.white,
